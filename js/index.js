...
function content(name, picture, zone, openTime, address, tel, ticketInfo) {
  ...
  <ul class="location_detail">
    ...
    <li><img src="https://github.com/yuchen820304/KaohsiungAPI/images/icons_clock.png" alt="" />${openTime}</li>
    <li><img src="https://github.com/yuchen820304/KaohsiungAPI/images/icons_pin.png" alt="" />${address}</li>
    <li><img src="https://github.com/yuchen820304/KaohsiungAPI/images/icons_phone.png" alt="" />${tel}</li>
    <li><img src="https://github.com/yuchen820304/KaohsiungAPI/images/icons_tag.png" alt="" />${ticketInfo}</li>
  </ul>
  `;
}
